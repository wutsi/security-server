[![](https://github.com/wutsi/security-server/actions/workflows/master.yml/badge.svg)](https://github.com/wutsi/security-server/actions/workflows/master.yml)
...
- Create a database named `security`
...
- Install
```
$ git clone git@github.com:wutsi/security-server.git
```
...
# Links
- [API](https://wutsi.github.io/security-server/api/)
- [Documentation](docs/)
